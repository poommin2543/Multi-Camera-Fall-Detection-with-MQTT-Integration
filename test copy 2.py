    ...
    while True:
        ...
        while cam.isOpened():
            ...
            if results.pose_landmarks:
                ...
                margin = 100  # ระยะที่อนุญาตให้อยู่ใกล้กริดแล้วตรวจจับ
                is_near_grid = (grid_x_min - margin <= transformed_center[0][0][0] <= grid_x_max + margin) and \
                               (grid_y_min - margin <= transformed_center[0][0][1] <= grid_y_max + margin)
